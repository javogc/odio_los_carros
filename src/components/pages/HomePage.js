        ...
        <div className="row mt-5">
          <div className="col-md-12">
            ...
            <p>
              ...
              <b>full-time front-end development posistions,</b> and I'm getting
              my self familiarized with <b>react</b> through building my
              personal portfolio with it. Below, you can see journal entries
              that document my learning process.
            </p>
          </div>
        </div>
      </Container>
